        ...
        <footer className="footer">
            <div className="footer__contact">
                ...
                <div className="footer__contact-form-wrap">
                    ...
                    {/* <form className="footer__contact-form" action="https://api.web3forms.com/submit" method="POST">
                        // Access key for the API 
                        <input className="footer__form-item footer__form-item--hidden" type="hidden" name="access_key" value="fc507a4d-e37b-46ec-b359-98218e4eca67" />
                        <label className="footer__form-label" for="name"></label>
                        <input className="footer__form-item footer__form-item--text" type="text" name="name" required placeholder="Name" />
                        <label className="footer__form-label" for="email"></label>
                        <input className="footer__form-item footer__form-item--text" type="email" name="email" required placeholder="Email" />
                        <label className="footer__form-label" for="message"></label>
                        <textarea className="footer__form-item footer__form-item--text" name="message" required placeholder="Your message here ..."></textarea>
                        // Honeypot Spam Protection
                        <label className="footer__form-label footer__form-label--checkbox" for="botcheck">Not a bot, are you?</label>
                        <input className="footer__contact-form-spam" type="checkbox" name="botcheck" />

                        // Custom Confirmation / Success Page
                        <input className="footer__form-item footer__form-item--text" type="hidden" name="redirect" value="https://mywebsite.com/thanks.html"/>

                        <button className="footer__form-item footer__form-item--button footer__form-item--text" type="submit">Submit </button>
                    </form> */}
                </div>
                <ul className="footer__contact-lists">
                    ...
                    <li className="footer__contact-list">
                        <a href="https://www.linkedin.com/in/andrea-holstein/" className="footer__contact-list--link footer__contact-list--item">
                            <svg className="footer__contact-list--link-icon footer__contact-list--item" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
