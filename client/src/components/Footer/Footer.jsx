...
export default function Footer() {
    ...
    return (
            ...
            <div className="footer__contact">
                ...
                <ul className="footer__contact-lists">
                    <li className="footer__contact-list">
                        ...
                        <h3 className="footer__contact-list--title footer__contact-list--item"><a href="https://www.imdb.com/name/nm10557260/" className="footer__contact-list--link footer__contact-list--item">IMDB</a></h3>
                    </li>
                    <li className="footer__contact-list">
		...
		C310,145.43,300.549,94.761,230.454,94.761z"/>
                        ...
                        <h3 className="footer__contact-list--item footer__contact-list--title"><a href="https://www.linkedin.com/in/andrea-holstein/" className="footer__contact-list--link footer__contact-list--item">LinkedIn</a></h3>
                    </li>
                </ul>
                <div className="footer__text-wrap">

                    <p className="footer__copyright">Andrea Holstein &copy; 2025</p>
